...
EngineDevice::EngineDevice(Window &window) : m_Window{window} 
{
  CreateInstance();
  SetupDebugMessenger();
  CreateSurface();
...
void EngineDevice::CreateInstance() 
{
  ...
  appInfo.pApplicationName = "Vryens Sebastiaan Vulkan";
...
void EngineDevice::CreateSurface() { m_Window.CreateWindowSurface(m_Instance, &m_Surface); }
...
void EngineDevice::CreateImage( uint32_t width, uint32_t height, VkFormat format, 
...
void EngineDevice::CreateTextureImage() 
{
    //int texWidth, texHeight, texChannels;
    //stbi_uc* pixels = stbi_load( "textures/jog_house.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha );
    ...
    //    m_TextureImages[0], m_TextureImagesMemory[0]);
}